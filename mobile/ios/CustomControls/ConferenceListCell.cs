...
namespace ios
{
	partial class ConferenceListCell : UITableViewCell
	{
...
//namespace ios
//{
//	partial class ConferenceCell : MvxTableViewCell
//	{
////		public static readonly UINib Nib = UINib.FromName ("ConferenceCell", NSBundle.MainBundle);
...
////				set.Bind(conferenceName).To (item => item.Name);
...
//		}
//
////		public static ConferenceCell Create ()
////		{
////			return (ConferenceCell)Nib.Instantiate (null, null) [0];
////		}
//
