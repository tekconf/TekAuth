...
namespace ios
{
	...
	public class AppDelegate : UIApplicationDelegate
	{
		...
		public override async void PerformFetch(UIApplication application, Action<UIBackgroundFetchResult> completionHandler)
		{
			...
			try
			{
				var service = ServiceLocator.Current.GetInstance<IConferencesService>();
				var settings = ServiceLocator.Current.GetInstance<ISettingsService>();
				var token = settings.UserIdToken;
				await service.GetConferences(token, Priority.Background);
